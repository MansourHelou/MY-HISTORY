...
class HowDeafness extends StatefulWidget {
  const HowDeafness({super.key});

  @override
  State<HowDeafness> createState() => _HowDeafnessState();
}

class _HowDeafnessState extends State<HowDeafness> {
  @override
        ...
        child: Column(
          children:<Widget>[
            ...
            Container(
              ...
              child: Padding(
                padding: const EdgeInsets.all(8.0),
                child: Text(" * Individualized Learning Plan: Work with your child's school to develop an Individualized Education Program (IEP) or a 504 plan tailored to their specific needs. ",
                  style: TextStyle(fontSize: 21),),
              ),
            ),
            SizedBox(height: 10),
            Container(
              ...
              child: Padding(
                padding: const EdgeInsets.all(8.0),
                child: Text(" * This plan may include accommodations such as extra time on tests, access to audiobooks, or preferential seating in the classroom.Assistive Technology: Explore assistive technology tools that can aid your child's learning. Text-to-speech software, speech recognition programs, and dyslexia-friendly fonts can help make reading and writing tasks more accessible.",
                  style: TextStyle(fontSize: 21),),
              ),
            ),
            SizedBox(height: 10),
            ...
            Container(
              ...
              child: Padding(
                padding: const EdgeInsets.all(8.0),
                child: Text(" * Seek Support: Connect with other parents of dyslexic children for support and advice. ",
                  style: TextStyle(fontSize: 21),),
              ),
            ),
            SizedBox(height: 10),
            Container(
              ...
              child: Padding(
                padding: const EdgeInsets.all(8.0),
                child: Text(" * Joining support groups or online communities can provide valuable insights and a sense of solidarity.",
                  style: TextStyle(fontSize: 21),),
              ),
            ),
            SizedBox(height: 10),
