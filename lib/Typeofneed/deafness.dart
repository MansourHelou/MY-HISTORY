...
import 'package:sample/English/engDeafness.dart';
import 'package:sample/Gaming/gDeafness.dart';
import 'package:sample/How to deal/howDeafness.dart';
import 'package:sample/pre-recognize/preDeafness.dart';
class Deafness extends StatefulWidget {
  const Deafness({super.key});
          ...
          child: Column(
            children: <Widget>[
              ...
              ElevatedButton(onPressed: (){
                Navigator.of(context).push(MaterialPageRoute(builder: (context) => engDeafness()));
              },child: Padding(
                padding: const EdgeInsets.only(right: 20,left: 20,top: 20,bottom: 20),
                child: Text("Definition for hearing loss or deafness",style: TextStyle(fontSize: 18,fontWeight: FontWeight.bold)),
              )),
              SizedBox(height: 20),


              ElevatedButton(onPressed: (){
                Navigator.of(context).push(MaterialPageRoute(builder: (context) => HowDeafness()));
              },child: Padding(
              ...
              ElevatedButton(onPressed: (){
                Navigator.of(context).push(MaterialPageRoute(builder: (context) => PreDeafness()));
              },child: Padding(
              ...
              ElevatedButton(onPressed: (){
                Navigator.of(context).push(MaterialPageRoute(builder: (context) => gDeafness()));
              },child: Padding(
